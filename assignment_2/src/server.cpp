...
class TiagoAction
{
    ...
    protected:
        ...
        actionlib::SimpleActionServer<assignment_2::TiagoAction> as_;
        std::string action_name_;
        assignment_2::TiagoFeedback feedback_;
        assignment_2::TiagoResult result_;
    public:
        ...
        void executeCB(const assignment_2::TiagoGoalConstPtr &goal)
        {
            // Helper variables
            ros::Rate r(1);
