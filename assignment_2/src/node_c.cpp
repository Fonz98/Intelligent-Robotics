...
class PPAction
{
    private:
        ...
        ros::NodeHandle nh_;
        actionlib::SimpleActionServer<assignment_2::PickPlaceAction> as_;
        std::string action_name_;
        assignment_2::PickPlaceResult result_;
        assignment_2::PickPlaceFeedback feedback_;
        ...
        bool pick_object(const assignment_2::PickPlaceGoalConstPtr& goal)
        {
        ...
        bool place_object(const assignment_2::PickPlaceGoalConstPtr& goal)
        {
            std::vector<std::string> collision_objects_ids;
            r.sleep();
    ...
    public:        
        ...
        void PickPlace(const assignment_2::PickPlaceGoalConstPtr& goal)
        {
