...
class DetectionAction
{
    ...
    protected:
        ros::NodeHandle nh_;
        actionlib::SimpleActionServer<assignment_2::DetectionAction> as_;
        std::string action_name_;
        assignment_2::DetectionResult result_;
        assignment_2::DetectionFeedback feedback_;
    ...
    public:
        ...
        void aprilCallback(const assignment_2::DetectionGoalConstPtr &goal)
        {
            // Helper variables
            ros::Rate r(1);
