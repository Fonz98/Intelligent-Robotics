...
#include <assignment_2/TiagoAction.h>
#include <assignment_2/DetectionAction.h>
#include <assignment_2/PickPlaceAction.h>
...
bool pick_place_object(const assignment_2::PickPlaceGoal& aGoal, assignment_2_group_27::PickPlaceGoal& aGoalPlace)
{
...
void markerDoneCb(const actionlib::SimpleClientGoalState& state,
            const assignment_2::DetectionResultConstPtr& result)
{
...
void markerActiveCb(){}
void markerFeedbackCb(const assignment_2::DetectionFeedbackConstPtr& feedback){}
...
bool move_tiago(const assignment_2::TiagoGoal& aGoal)
{
    // Create the action client. We also tell the action client that we want to spin a thread by default
...
geometry_msgs::Point find_cylinder_position(const assignment_2::TiagoResultConstPtr& result, const int& aID)
{
...
geometry_msgs::Point move_tiago_detection(const assignment_2::TiagoGoal& aGoal, const int& aID)
{
    geometry_msgs::Point tmp;
    // Create the action client. We also tell the action client that we want to spin a thread by default
...
int main(int argc, char **argv)
{
    ...
    assignment_2::TiagoGoal goal_object;
    assignment_2::TiagoGoal goal_cylinder;
    assignment_2::TiagoGoal goal_waypoint;    
    
    // Define the detection goal
    assignment_2::DetectionGoal goal_ID;
    ...
    for (int i=0; i < ids.size(); i++)
    {
        ...
        assignment_2::DetectionResultConstPtr detection_ptr = marker_detection(goal_ID);
        ...
        assignment_2::PickPlaceGoal goal_pick;
        goal_pick.pick = true;
        ...
        assignment_2::PickPlaceGoal goal_place;
        ...
        assignment_2::PickPlaceGoal place_holder;
